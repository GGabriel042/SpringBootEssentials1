...
public class StudentEndpointTokenTest {
    ...
    public void configWrongHeaders() {
        ...
        headers.add("Authorization", "1111111111");
    ...
    @Test
    public void listStudentsWhenTokesIsCorrectShouldReturnStatusCode200() {
    ...
    @Test
    public void deleteWhenUserHasRolaAdminAndStudentExistShouldReturnStatusCode200() {
